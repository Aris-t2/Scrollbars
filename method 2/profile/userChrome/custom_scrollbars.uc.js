...
/* ***********************************************************************************************
 ...
 - color - name: blue / hex code: #33CCFF / rgb(a): rgba(0,0,255,0.8) / hsl(a): hsla(240,100%,50%,0.8)
 ...
 NOTE
 - this is not a port of 'NewScrollbars' add-on, just a collection of scrollbar tweaks!
...
var hide_scrollbar_buttons = true; /* default > false */
var custom_scrollbar_width = true; /* default > false */
var custom_scrollbar_width_value = 7; /* 10-? // default > 17 (in px) */
var custom_scrollbar_opacity = false; /* default > false */
var custom_opacity_value = "1.0"; /* default > 1.0 */
var enable_floating_scrollbars = true; /* scrollbars on top of web content */

// Custom scrollbar appearance settings - "cs"
var enable_custom_scrollbars = true;
var cs_background_color = "transparent"; /* default > #CCCCCC */
var cs_background_image = "linear-gradient(to right,transparent,transparent,transparent)"; /* default > none */
var cs_thumb_color = "#33CCFF"; /* default > #33CCFF */
var cs_thumb_image = "linear-gradient(to right,transparent,rgba(255,255,255,0.3),transparent)"; /* default > none */
var cs_thumb_hover_color = "#33CCFF"; /* default > #66FFFF */
var cs_thumb_hover_image = "linear-gradient(to right,transparent,rgba(255,255,255,0.5),transparent)"; /* default > none */
var cs_thumb_roundness = 20; /* default > 0 (in px) */
...
var cs_buttons_image = "linear-gradient(to right,transparent,transparent,transparent)"; /* default > none */
var cs_buttons_hover_color = "#000066"; /* default > #000066 */
var cs_buttons_hover_image = "linear-gradient(to right,transparent,transparent,transparent)"; /* default > none */
